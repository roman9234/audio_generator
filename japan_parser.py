...
def clean_and_split_sentences_jp(text):
    ...
    for sent in sentences:
        ...
        if word_count < 7:  # Минимум 7 "слов" по заданию
            continue
...
def process_all_books_jp(book_folder, output_folder, required_count=12000):
    ...
    # parsed_path = os.path.join(output_folder, "japanese_parsed_all.txt")
...
if __name__ == "__main__":
    ...
    final_file = os.path.join(OUTPUT_FOLDER, f"japanese_parsed_all.txt")
